...
Item {
    ...
    //satcomtest
    property var    isSatcomCheck:      QGroundControl.linkManager.switchSatcomClick
    ...
    property var    highLatencyCheck:   QGroundControl.linkManager.connectedLinkHighLatency
